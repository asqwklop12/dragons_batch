...
class FeignConfigTest {
  ...
  void decoderReadsJsonBodiesReturnedAsTextPlain() throws Exception {
    ...
    Decoder decoder = feignConfig.feignDecoder(new JacksonConfig().objectMapper());
    Response response = buildTestResponse(
        """
            {
              "error_code": "000",
              "price": [
  ...
  private Response buildTestResponse(String body) {
